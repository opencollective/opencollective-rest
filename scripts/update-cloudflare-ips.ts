/**
 * Refreshes the list of Cloudflare IP ranges that Express trusts as proxies (`src/server/cloudflare-ips.json`),
...
const output = process.argv[2] || 'src/server/cloudflare-ips.json';
